...
$database_dsn = 'mysql:dbname=ddcocina;host=mysql.alacor.com';
$database_username = 'ddcocina';
$database_password = 'D1ccionario';
...
//				return new PDO($database_dsn, $database_username, $database_password, array(PDO::MYSQL_ATTR_USE_BUFFERED_QUERY => true));
				

try {
    $dbh = new PDO($database_dsn, $database_username, $database_password, array(PDO::MYSQL_ATTR_USE_BUFFERED_QUERY => true));
